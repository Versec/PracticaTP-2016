...
public class Replace implements Command {
	...
	public Command parse(String... line) {
		if (line.length==2 && line[0].equalsIgnoreCase("REPLACEBC") && line[1].matches("(\\+)?[0-9]+")){		
	...
	public String textHelp() {
		return "REPLACEBC N: Reemplaza la instruccion N por la solicitada al usuario" + System.getProperty("line.separator");
	}
